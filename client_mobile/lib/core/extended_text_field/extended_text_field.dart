import 'package:client_core/platform.dart';
...
import 'extended_text/render_object/extended_text_selection_render_object.dart';
import 'extended_text/selection/cupertino_text_selection_controls.dart';
import 'extended_text/selection/extended_text_selection.dart';
import 'extended_text/selection/material_text_selection_controls.dart';
import 'extended_text/special_text_span_builder.dart';
...
class ExtendedTextField extends StatefulWidget {
  ...
  ///
  /// ```dart
  /// focusNode.addListener(() { l.i(myFocusNode.hasFocus); });
  /// ```
  ///
...
class _ExtendedTextFieldState extends State<ExtendedTextField>
  ...
  void _handleSelectionChanged(
    ...
    switch (mapPlatform(Theme.of(context).platform)) {
  ...
  Widget build(BuildContext context) {
    ...
    switch (mapPlatform(themeData.platform)) {
      case PlatformType.macOS:
      case PlatformType.iOS:
        //case TargetPlatform.macOS:
