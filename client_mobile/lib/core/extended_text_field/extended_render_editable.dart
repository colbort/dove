...
import 'extended_text/background_text_span.dart';
import 'extended_text/extended_text_utils.dart';
...
//              supportSpecialText && hasSpecialText(text) ? null : strutStyle,
        ...
        _floatingCursorAddedMargin = floatingCursorAddedMargin ?? EdgeInsets.fromLTRB(ds.d4, ds.d4, ds.d4, ds.d5),
...
//   }
  ...
  Rect get _getCaretPrototype {
    ...
    switch (mapPlatform(defaultTargetPlatform)) {
      // ignore: todo
      case PlatformType.macOS: // TODO 这里应该是这样吗？需要测试
