...
const UpdatesGetChannelDifferenceRequest$json = const {
  '1': 'UpdatesGetChannelDifferenceRequest',
  '2': const [
    ...
    const {'1': 'filter', '3': 4, '4': 1, '5': 11, '6': '.pb_uuchat.ChannelMessagesFilterAbsClass', '10': 'filter'},
    const {'1': 'pts', '3': 5, '4': 1, '5': 5, '10': 'pts'},
    const {'1': 'limit', '3': 6, '4': 1, '5': 5, '10': 'limit'},
  ],
};

const UpdatesGetDifferenceRequest$json = const {
  '1': 'UpdatesGetDifferenceRequest',
  '2': const [
    const {'1': 'RequestCtx', '3': 1, '4': 1, '5': 11, '6': '.pb_rpc.Context', '10': 'RequestCtx'},
    const {'1': 'pts', '3': 2, '4': 1, '5': 5, '10': 'pts'},
    const {'1': 'ptsTotalLimit', '3': 3, '4': 1, '5': 5, '10': 'ptsTotalLimit'},
    const {'1': 'date', '3': 4, '4': 1, '5': 5, '10': 'date'},
    const {'1': 'qts', '3': 5, '4': 1, '5': 5, '10': 'qts'},
  ],
};

const UpdatesGetStateRequest$json = const {
  '1': 'UpdatesGetStateRequest',
  '2': const [
    const {'1': 'RequestCtx', '3': 1, '4': 1, '5': 11, '6': '.pb_rpc.Context', '10': 'RequestCtx'},
  ],
};

const UpdatesGetChannelDifferenceResponse$json = const {
  '1': 'UpdatesGetChannelDifferenceResponse',
  '2': const [
    const {'1': 'RespCtx', '3': 1, '4': 1, '5': 11, '6': '.pb_rpc.RespContext', '10': 'RespCtx'},
    const {'1': 'updatesChannelDifferenceAbsClass', '3': 2, '4': 1, '5': 11, '6': '.pb_uuchat.UpdatesChannelDifferenceAbsClass', '10': 'updatesChannelDifferenceAbsClass'},
  ],
};

const UpdatesGetDifferenceResponse$json = const {
  '1': 'UpdatesGetDifferenceResponse',
  '2': const [
    const {'1': 'RespCtx', '3': 1, '4': 1, '5': 11, '6': '.pb_rpc.RespContext', '10': 'RespCtx'},
    const {'1': 'updatesDifferenceAbsClass', '3': 2, '4': 1, '5': 11, '6': '.pb_uuchat.UpdatesDifferenceAbsClass', '10': 'updatesDifferenceAbsClass'},
  ],
};

const UpdatesGetStateResponse$json = const {
  '1': 'UpdatesGetStateResponse',
  '2': const [
    const {'1': 'RespCtx', '3': 1, '4': 1, '5': 11, '6': '.pb_rpc.RespContext', '10': 'RespCtx'},
    const {'1': 'updatesState', '3': 2, '4': 1, '5': 11, '6': '.pb_uuchat.UpdatesState', '10': 'updatesState'},
  ],
};

const updatesServerServiceBase$json = const {
  '1': 'updatesServer',
  '2': const [
    const {'1': 'UpdatesGetChannelDifference', '2': '.pb_uuchat.UpdatesGetChannelDifferenceRequest', '3': '.pb_uuchat.UpdatesGetChannelDifferenceResponse', '4': const {}},
    const {'1': 'UpdatesGetDifference', '2': '.pb_uuchat.UpdatesGetDifferenceRequest', '3': '.pb_uuchat.UpdatesGetDifferenceResponse', '4': const {}},
    const {'1': 'UpdatesGetState', '2': '.pb_uuchat.UpdatesGetStateRequest', '3': '.pb_uuchat.UpdatesGetStateResponse', '4': const {}},
  ],
};

const updatesServerServiceBase$messageJson = const {
  '.pb_uuchat.UpdatesGetChannelDifferenceRequest': UpdatesGetChannelDifferenceRequest$json,
  ...
  '.pb_uuchat.ChannelMessagesFilterAbsClass': $1.ChannelMessagesFilterAbsClass$json,
  '.pb_uuchat.ChannelMessagesFilterEmpty': $1.ChannelMessagesFilterEmpty$json,
  '.pb_uuchat.ChannelMessagesFilter': $1.ChannelMessagesFilter$json,
  '.pb_uuchat.MessageRange': $1.MessageRange$json,
  '.pb_uuchat.UpdatesGetChannelDifferenceResponse': UpdatesGetChannelDifferenceResponse$json,
  '.pb_rpc.RespContext': $0.RespContext$json,
  '.pb_uuchat.UpdatesChannelDifferenceAbsClass': $1.UpdatesChannelDifferenceAbsClass$json,
  '.pb_uuchat.UpdatesChannelDifferenceEmpty': $1.UpdatesChannelDifferenceEmpty$json,
  '.pb_uuchat.UpdatesChannelDifferenceTooLong': $1.UpdatesChannelDifferenceTooLong$json,
  ...
  '.pb_uuchat.UpdatesChannelDifference': $1.UpdatesChannelDifference$json,
  ...
  '.pb_uuchat.UpdatesGetDifferenceRequest': UpdatesGetDifferenceRequest$json,
  '.pb_uuchat.UpdatesGetDifferenceResponse': UpdatesGetDifferenceResponse$json,
  '.pb_uuchat.UpdatesDifferenceAbsClass': $1.UpdatesDifferenceAbsClass$json,
  '.pb_uuchat.UpdatesDifferenceEmpty': $1.UpdatesDifferenceEmpty$json,
  '.pb_uuchat.UpdatesDifference': $1.UpdatesDifference$json,
  '.pb_uuchat.UpdatesState': $1.UpdatesState$json,
  '.pb_uuchat.UpdatesDifferenceSlice': $1.UpdatesDifferenceSlice$json,
  '.pb_uuchat.UpdatesDifferenceTooLong': $1.UpdatesDifferenceTooLong$json,
  '.pb_uuchat.UpdatesGetStateRequest': UpdatesGetStateRequest$json,
  '.pb_uuchat.UpdatesGetStateResponse': UpdatesGetStateResponse$json,
};
